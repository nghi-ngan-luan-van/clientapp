...
export default class HomeNavigator extends React.PureComponent {
     getHeaderTitle(route) {
        ...
        const routeName = route && route.name? route.name: route.state
        ...
        return (
            <Stack.Navigator {...this.props} initialRouteName={AppRoute.HOME}
                             screenOptions={( {route={}} ) => ({
                                 ...
                                 headerBackImage:()=><Image style={{width:18, height:18}} source={require('../assets/ic_back.png')}/>,
            ...
            >
                <Stack.Screen
                    ...
                    options={({ route }) => ({
                        ...
                        // headerShown:false,
                        // headerTitle: 'Hello',
                        headerLeft:()=><TouchableOpacity><Image style={{margin:12,width:30, height:30}} source={require('../assets/ic_rainbow.png')}/></TouchableOpacity>,
                    })}
